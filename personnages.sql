INSERT INTO `personnages` VALUES 
    ...
    (20, 'Star-Lord','photoStarLord','Star-Lord'),------
    ...
    (29, 'Ant-Man','photoAntMan','Ant-Man'),-----
    (30, 'La Guêpe','photoLaGuêpe','La Guêpe'),----
    (31, 'Spider-Man','photoSpiderMan','Spider-Man'),----
    (32, 'Black Panther','photoBlackPanther','Black Panther'),-------
    (33, 'Vision','photoVision','Vision'),
    (34, 'Docteur Strange','photoDocteurStrange','Docteur Strange'),----
    ...
    (43, 'Captain Marvel','photoCaptainMarvel','Captain Marvel'),
